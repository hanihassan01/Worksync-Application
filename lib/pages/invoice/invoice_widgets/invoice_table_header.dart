    ...
    final headerRow = Container(
      ...
      child: Row(
        children: [
          ...
          _buildHeaderCell('Description', descriptionWidth),
          _buildHeaderCell('Qty', qtyWidth),
          _buildHeaderCell('Unit Price', unitPriceWidth),
          _buildHeaderCell('HSN', hsnWidth),
          _buildHeaderCell('Tax %', taxRateWidth),
          _buildHeaderCell('Line Total', lineTotalWidth),
        ],
      ),
    );
